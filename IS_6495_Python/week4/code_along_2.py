...
exaample_dict = {
    ...
    "name": "Odin",
    "a_boolean": True,
    "another_dict": {"you could": "keep going", "like this": "forever"},
}

for key in exaample_dict:
    print(key)

for item in exaample_dict.items():
    print(item)

for v in exaample_dict.values():
    print(v)
