...
student = Student("Jamison", "Orton", "0802977")
student.add_class("Python")
student.add_class("Economics")
print(student.get_schedule())

athlete = Athlete("Jamison", "Orton", "0802977", "Basketball")

staff = Staff("Jamison", "Orton", "0802977", 100000)

teacher = Teacher("Jamison", "Orton", "0802977", 100000)
